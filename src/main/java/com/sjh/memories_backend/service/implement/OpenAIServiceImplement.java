...
import com.sjh.memories_backend.common.dto.request.openai.ChatRequestDto;
...
import com.sjh.memories_backend.common.dto.response.openai.ChatResponseDto;
...
public class OpenAIServiceImplement implements OpenAIService {
  ...
  public ResponseEntity<? super GetWayResponseDto> getWay(GetWayRequestDto dto, String userId) {
    ...
    String content = "대한민국 " + age + "세 " + gender + "이 " + type + "을 높일 수 있는 방법에 대해 알려주세요. 마크다운으로 작성해주세요.";
